...
print(f"{BRIGHT_BLUE}cache: {BRIGHT_RED}without{BRIGHT_YELLOW} KV cache{RESET}", file=sys.stderr)
...
print(f"{BRIGHT_YELLOW}New tokens rate is {tokens_per_second:.2f}{RESET}", file=sys.stderr)
print(f"{BRIGHT_YELLOW}Elapsed time is {elapsed:.2f}{RESET}", file=sys.stderr)
# print(f"{BRIGHT_YELLOW}AllInputTokens/elapsedTime is{global_vars.total_tokens / elapsed}{RESET}", file=sys.stderr)
